...
/**
 * alias ChannelProductPageModel<br>
 * 类: InventoryPageModel <br>
 * 描述: 跨境通商品库存同步分页model <br>
 * 作者: 张海宇 zhanghaiyu@huijiayou.cn<br>
 * 时间: 2016年6月27日 下午5:44:48
 */
public class InventoryPageModel {
	...
	public InventoryPageModel(List list, int pageRecorders) {

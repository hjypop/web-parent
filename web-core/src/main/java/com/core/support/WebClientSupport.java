...
import com.core.pojo.entity.system.WebClientRequest;
...
public class WebClientSupport extends BaseClass {
	...
	public static String upHttpsPost(WebClientRequest webClientRequest) throws NoSuchAlgorithmException,
	 ...
	 * @throws IOException
	 */
	public static String poolRequest(String sUrl, HttpEntity httpEntity, MDataMap headerDataMap)
